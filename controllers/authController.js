...
module.exports.login_post = async (req, res) => {
    console.log(3); // Solo para debug, puedes eliminar esta línea
    ...
    try {
        ...
        console.log(333); // Solo para debug, puedes eliminar esta línea
...
module.exports.updateAccountEmail_post = async (req, res) => {
    ...
    try {
        ...
        if(error.message == 'Introduce un correo electrónico válido') {
            res.status(400).json({ error: error.message });
        } else if (error.message == 'Ya existe un usuario con ese correo electrónico') {
            res.status(400).json({ error: error.message })
        } else {
            res.status(400).json({ error: error.message });
        }
